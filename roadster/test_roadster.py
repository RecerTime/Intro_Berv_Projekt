...
def test_part1a_C():
    ...
    ref_array  = np.array([5518.3360221 ,   84.14098486,   93.50181036,  437.92663867])        
...
def test_part3a_A():
    route = 'speed_anna.npz'
    T = 0.5
    # ref_value computed with N = 10000001 in trap and tol = 1e-10 in Newton
